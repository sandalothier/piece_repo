...
@RestController
@RequestMapping("/api/piece-kafka")
public class PieceKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PieceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PieceKafkaResource(KafkaProperties kafkaProperties) {
